...
public class StringUtil {
  ...
  public static String trim(String value, String defaultValue) {
    if (value == null || "".equals(value) || "null".equals(value) || "\\N".equals(value))
      return defaultValue;
    else
      return value.trim();
  }
  ...
  public static BigDecimal div(long value1, int value2) {
    ...
    return new BigDecimal(value1).divide(new BigDecimal(value2), 4, BigDecimal.ROUND_HALF_UP);
  }
  ...
  public static BigDecimal div(String value1, String value2) {
    ...
    return div(Long.parseLong(value1),Integer.parseInt(value2));
  }
  ...
  public static BigDecimal div(int value1, int value2) {
    ...
    return div((long)value1,value2);
  }
  
  //组装集合,将集合按照char进行组装,避免length-l这种笨拙方式
  ...
  public static String parseLineForString(String line, String key, String separator,
      String defaultStr) {
